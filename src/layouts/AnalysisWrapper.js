...
const MoreMenu = ({ openSavedViewDialog, openShareDialog }) => (
  <CDropdown>
    ...
    <CDropdownMenu placement="bottom-start">
      ...
      <CDropdownItem>Send Now</CDropdownItem>
      <CDropdownItem className="disabled">Send On A Schedule</CDropdownItem>
    </CDropdownMenu>
  </CDropdown>
)
